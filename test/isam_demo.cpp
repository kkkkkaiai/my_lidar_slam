...
int main(){
    ...
    gra.emplace_back(1, 2, Pose2(2, 0, 0), model);
    gra.emplace_back(2, 3, Pose2(2, 0, 0), model);
    gra.emplace_back(3, 4, Pose2(2, 0,  M_PI_2), model);
    gra.emplace_back(4, 5, Pose2(2, 0,  M_PI_2), model);
    gra.emplace_back(5, 2, Pose2(2, 0,  M_PI_2), model);

    initPose.emplace_back(0.5, 0.0,  0.2   );
    initPose.emplace_back(2.3, 0.1, -0.2   );
    initPose.emplace_back(4.1, 0.1,  M_PI_2);
    initPose.emplace_back(4.0, 2.0,  M_PI  );
    initPose.emplace_back(2.1, 2.1, -M_PI_2);
